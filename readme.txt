0) Run vrbo_data_scraper.py to generate the folders, vrbo_texts and within that, inputs and outputs.
1) Place a text files containing text from a vrbo page (can just use ctrl-a) into inputs.
